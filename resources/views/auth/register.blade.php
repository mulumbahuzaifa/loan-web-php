<x-guest-layout>
    ...
    <!-- Banner End -->
    <section id="login-section" class="mt-120">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-12">
                    <div class="form-head login-form">
                        <h4 class="title mb-30">Register</h4>
                        ...
                        <form class="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="input-group mb-30">
                                    <span class="input-group-text" id="basic-addon3"><i class="fa fa-lock"></i></span>
                                        <input type="password"  class="form-control" name="password_confirmation" placeholder="Comfirm Password" required autocomplete="new-password" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;">
                                </div>
                                <div class="button mb-30">
                                    <button type="submit" class="btn btn-one">Register Now</button>
                                </div>

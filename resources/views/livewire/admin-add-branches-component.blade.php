...
<div class="col-md-12 mb-10">
  <h1 class="text-light">Add Branch</h1>
</div>
<div class="col-md-12">
...
<div class="panel panel-default">
  <div class="panel-heading">
      <div class="row">
          ...
          <div class="col-md-6">
              <a href="{{ route('admin.branches') }}" style="color: rgb(235, 235, 235)" class="btn btn-success pull-right"> All Branches</a>
          </div>
      </div>
  </div>
  ...
  <div class="panel-body">
      <form action="" class="form-horizontal" wire:submit.prevent="storeBranch">
          ...
          <div class="form-group">
              <label for="" class="col-md-4 control-lable">P.O Box mail</label>
              <div class="col-md-4">
